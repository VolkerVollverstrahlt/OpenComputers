...
class Charger(selfType: TileEntityType[_ <: Charger]) extends BlockEntity(selfType) with traits.Environment with traits.PowerAcceptor with traits.RedstoneAware
